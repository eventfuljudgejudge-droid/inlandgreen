  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 28px" }}>
        <div style={{ width: 180, height: 28, borderRadius: 6, background: "var(--slate-100)", marginBottom: 8 }} />
        <div style={{ width: 300, height: 16, borderRadius: 4, background: "var(--slate-100)", marginBottom: 36 }} />
